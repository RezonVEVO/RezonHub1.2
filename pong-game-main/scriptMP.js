...
//alt fra av at du beveger paddelene og ballen flyr
gameLoop()
...
//score går up
            ...
            //det samme men for p2
            if(O_Pressed && marginTop(compPaddle)>0){
                compPaddle.style.marginTop = `${marginTop(compPaddle)-3}px`
            }
            else if(L_Pressed && marginTop(compPaddle)<472){
                compPaddle.style.marginTop = `${marginTop(compPaddle)+3}px`
            }
